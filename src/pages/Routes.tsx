...
const AccountWishlistPage = React.lazy(() => import('./account/WishlistPage'))
const AccountFollowingShopPage = React.lazy(
  () => import('./account/FollowingShopPage')
)
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        />
        <Route
          path='/account/following-shop'
          element={
            <PrivateRoute>
              <AccountFollowingShopPage />
            </PrivateRoute>
          }
        />
        <Route
