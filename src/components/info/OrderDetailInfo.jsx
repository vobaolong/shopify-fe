...
const OrderDetailInfo = ({
  ...
  const init = useCallback(() => {
    ...
    setIsLoading(true)
    if (by === 'store')
      getOrderByStore(_id, orderId, storeId)
        .then((data) => {
