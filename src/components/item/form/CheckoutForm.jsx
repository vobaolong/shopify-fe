...
const CheckoutForm = ({
  ...
  const init = async () => {
    try {
      ...
      const res3 = await getAddress(encodeURIComponent(storeAddress))
      const res4 = await getAddress(encodeURIComponent(order.address))
      ...
      setOrder({
        ...
        amountToBuynow: amountFromUser - amountToStore
      })
    } catch {
