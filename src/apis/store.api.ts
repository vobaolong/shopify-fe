...
export const getListStores = async (params: any) => {
  return await axiosClient.get('/stores', {
    params
  })
}

export const getStoresByUser = async (userId: string, params: any) => {
  return await axiosClient.get(`/stores/by/user/${userId}`, {
    params
  })
}

export const getStoresForAdmin = async (params: any) => {
...
export const activeStore = async (storeId: string, params: any) => {
